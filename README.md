...
Green is the GPS-anchored calibration leg; blue is NURON's own estimate with no GPS at all.

### All session recordings

Every on-site session, **complete and unedited** — 2250 frames each, 1920×1080, original
encoding. Hosted as release assets so cloning this repository stays cheap.
